...
| 文档 | 路径 | 包含内容 |
|------|------|----------|
| 迭代记录 | `D:\AI\ragflow2\CHANGE.md` | ★ 全部新增需求/功能整改记录：流程页签工作流（08-30）、文件审核 Word 式工具栏 + run 级格式落盘（08-31，最新）等，最新迭代在最上方 |
...
| 人事模块设计 | `D:\AI\ragflow2\docs\superpowers\specs\2026-08-31-hr-module-design.md` | ★ C端「人事」页签：打卡考勤/请假审批/薪资核算/财务凭证 4模块20功能点，13张hr_*表+30端点+4阶段实施；P1 已上线，P2（请假审批）与 P3（薪资核算）已实施待部署，实施计划 docs/superpowers/plans/2026-09-01-hr-p2-leave.md 与 2026-09-01-hr-p3-salary.md |
