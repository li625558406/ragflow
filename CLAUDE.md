...
| 人事模块设计 | `D:\AI\ragflow2\docs\superpowers\specs\2026-08-31-hr-module-design.md` | ★ C端新增「人事」页签：打卡考勤/请假审批/薪资核算/财务报表 4模块20功能点，13张 hr_* 表 + hr_app.py + 独立审批链，复用RBAC与通知系统；分4阶段实施（P1考勤→P2请假→P3薪资→P4财务），设计已确认待实施 |
