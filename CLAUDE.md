...
| 模板填写系统设计 | `D:\AI\ragflow2\docs\superpowers\specs\2026-09-07-template-fill-design.md` | ★ 固定模板（Word/Excel）+ KB 自动填写：tpl_ 3表、占位符注册表、LLM产字段值JSON+docxtpl/openpyxl渲染、B端模板库页签 + C端对话工具/flow节点双入口，P1-P4 分期 |
