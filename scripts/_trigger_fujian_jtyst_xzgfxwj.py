"""
Trigger fujian_jtyst_xzgfxwj crawler_task from inside the container,
...
TASK_ID = "0e55ef4e89c511f184daea173a0699f4"
...
def main():
    ...
    # Same as trigger_task for YAML site (category=policy → collection)
    ...
    summary = {
        "status": status,
        "pages": 1,
        "items_found": 15 if status == "success" else 0,
        "items_new": 15 if status == "success" else 0,
        "kb_uploaded": 15 if status == "success" else 0,
