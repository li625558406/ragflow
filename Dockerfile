...
# libreoffice:   .doc → .docx conversion for file review annotation system
# antiword catdoc: .doc text extraction fallback (when LibreOffice unavailable)
