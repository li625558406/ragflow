...
[在此处插入文本]`,
    ...
    crawl4ai: {
      ...
      parseMonitor: {
        ...
        rerunBtn: '批量重跑',
        rerunBtnReason: '重跑本类',
        rerunConfirmTitle: '确认批量重跑',
        rerunConfirmBody:
          '将重置 {{total}} 个失败文档并重新入队解析队列，是否继续？',
        rerunConfirmBodyReason:
          '将重置 {{total}} 个「{{reason}}」失败文档并重新入队解析队列，是否继续？',
        rerunRunning: '正在重跑…',
        rerunDone:
          '重跑完成：成功 {{success}} / 失败 {{failed}} / 跳过 {{skipped}}，耗时 {{sec}}s',
    ...
    notifications: {
      admin: {
        tab: '通知管理',
        statsTodayCreated: '今日生成',
        statsWeekPushed: '本周推送',
        statsReadRate: '本周已读率',
        filterSite: '站点',
        filterCategory: '分类',
        categoryAll: '全部',
        ...
        noData: '暂无数据',
        delete: '删除',
        confirmDelete: '确认删除该通知？级联删除用户记录。',
        batchDelete: '批量删除',
        confirmBatchDelete:
          '确认删除选中的 {{count}} 条通知？将级联删除对应用户记录。',
        deleting: '删除中…',
        selectAll: '全选当前页',
        selectRow: '选择该行',
        totalHint: '共 {{total}} 条（仅展示前 50 条）',
      },
    },
    permission: {
      title: '权限管理',
      roleManage: '角色与权限管理',
      roleSubtitle: '维护角色与模块权限，内置角色不可删除',
      roleAssignTitle: '用户角色分配',
      roleAssignSubtitle: '以角色为粒度分配模块权限，多角色权限取并集',
      roleCount: '角色数',
      userCount: '用户数',
      superuserCount: '超级管理员',
      assignedUserCount: '已分配角色用户',
      searchRole: '按角色名搜索',
      searchUser: '按邮箱或昵称搜索',
      ...
      duplicateRoleName: '角色名已存在',
      actions: '操作',
      delete: '删除',
      deleteUser: '删除用户',
      confirmDeleteUser: '确认删除该用户？删除后该用户将无法登录系统',
      empty: '暂无数据',
      noRoles: '暂无角色，请先在上方创建角色',
    },
  },
};
