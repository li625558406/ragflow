...
以上就是你需要总结的内容。`,
      ...
      bidSearch: '标书搜索',
      bidSearchDescription: '搜索国内招投标项目',
      bidGetDetail: '标书详情',
      bidGetDetailDescription: '获取标书项目详细信息',
      bidImportToKb: '导入知识库',
      bidImportToKbDescription: '将标书项目导入知识库并触发解析',
      bidCheckImportStatus: '查询导入状态',
      bidCheckImportStatusDescription: '查询标书项目导入和解析的进度',
      bidLookupCode: '编码查询',
      bidLookupCodeDescription: '根据中文名称查询行政区划或行业编码',
      bidGetSource: '获取来源网址',
      bidGetSourceDescription: '获取标书项目的原始采集网址',
      bidSearchAI: '智能标讯搜索',
      bidSearchAIDescription: '使用自然语言条件搜索标讯项目',
      bidSearchContract: '合同搜索',
      ...
      tenderSearchTitle: '标讯搜索',
      tenderSearchDescription: '搜索全国招标采购信息',
      tenderKeyword: '关键词',
      tenderKeywordPlaceholder: '输入至少2个字符的关键词...',
      tenderSearchMode: '搜索模式',
      tenderFuzzy: '模糊搜索',
      tenderPrecise: '精确搜索',
      tenderAnnouncementType: '公告类型',
      tenderAllTypes: '全部类型',
      tenderBidAnnouncement: '招标公告',
      tenderBidResult: '招标结果',
      tenderPublishDate: '发布日期',
      tenderSearching: '搜索中...',
      tenderSearchBtn: '搜索标讯',
      tenderResults: '条结果',
      tenderNoResults: '未找到匹配结果',
      tenderNoResultsHint: '请调整查询条件后重试',
      tenderBack: '返回',
      tenderStaleCache: '缓存数据可能已过期，建议稍后刷新',
      tenderQueryFailed: '查询失败',
      tenderLoadComplete: '已显示全部结果',
      tenderLoadingMore: '加载中...',
      tenderLoaded: '已加载',
      tenderBudget: '预算:',
      tenderWinBid: '中标:',
      tenderContractLabel: '合同:',
      tenderBidOpening: '开标:',
      tenderBidDeadline: '投标截止:',
      tenderWinCandidate: '中标候选：',
      tenderAgency: '代理：',
      tenderBadgeBid: '招标',
      tenderBadgeWin: '中标',
      tenderBadgeDefault: '标讯',
      tenderTotal: '共',
      crawlFetch: '网站爬取',
      ...
      logTimeline: {
        ...
        bidSearch: '搜索标书项目',
        bidGetDetail: '获取标书详情',
        bidImportToKb: '导入标书到知识库',
        bidCheckImportStatus: '查询标书导入进度',
        bidLookupCode: '查询编码',
        exeSQL: '查询数据库',
        google: '正在网上搜索',
        wikipedia: '搜索维基百科',
...
[在此处插入文本]`,
    ...
    analysisTemplate: {
      ...
      docType: '文档类型',
      docTypePlaceholder: '请选择文档类型',
      dimensions: '分析维度',
      dimensionsPlaceholder: '请选择分析维度',
      promptTemplate: '提示词模板',
      promptTemplatePlaceholder: '请输入提示词模板',
      cannotEditSystem: '系统模板不可编辑',
    ...
    scheduledTasks: {
      ...
      toggleEnable: '启用/禁用',
      targetUrl: '目标网址',
      targetUrlPlaceholder: '请输入爬取目标网址',
      accessToken: '访问令牌',
      accessTokenPlaceholder: '请输入用于认证爬取的访问令牌',
      llmModel: '图片分析模型',
      llmModelPlaceholder: '选择用于图片分析的 LLM 模型',
      targetKb: '目标知识库',
      targetKbPlaceholder: '选择存入的知识库',
      running: '运行中',
      success: '成功',
      fail: '失败',
      noTasks: '暂无定时任务',
      createTaskHint: '创建定时任务以周期性地执行 Python 脚本',
      taskNameRequired: '请输入任务名称',
      scriptPathRequired: '请输入脚本路径',
      crawlerState: '爬虫状态',
      crawlerStateSaveSuccess: '保存成功',
      crawlerStateSaveFailed: '保存失败',
      crawlerStateInvalidJson: 'JSON 格式无效',
      log: {
        title: '执行日志',
        startTime: '开始时间',
        endTime: '结束时间',
      ...
      taskType: '任务类型',
      taskTypeScript: '通用脚本',
      taskTypeWechatMp: '微信公众号采集',
      wechatMpAuth: '微信授权',
      wechatMpScanLogin: '扫码登录',
      wechatMpLoggedIn: '已登录',
      wechatMpLogout: '退出登录',
      wechatMpSearchPlaceholder: '搜索公众号...',
      wechatMpSelectedAccounts: '已选公众号',
      wechatMpGatherContent: '采集文章正文内容',
      wechatMpNoAccount: '请先添加公众号',
      wechatMpQrScanning: '请用微信扫码',
      wechatMpAuthExpired: '登录已过期，请重新扫码',
      wechatMpFirstMaxPage: '首次全量采集最大页数',
      wechatMpFirstMaxPageHint:
        '首次运行时全量采集的页数（1页=5篇）。后续增量运行时仅采集最新1页。',
    },
    crawl4ai: {
      title: '智能采集',
      results: '采集结果',
      ...
      allStatus: '全部状态',
      statusRaw: '已采集',
      statusKbUploaded: '已入知识库',
      statusFailed: '失败',
      status_raw: '已采集',
      status_kb_uploaded: '已入知识库',
      status_failed: '失败',
      resultTitle: '标题',
      publishDate: '发布日期',
      attachmentCount: '附件数',
      ...
      fieldName: '字段',
      fieldValue: '值',
      rawExtractedJson: '原始 JSON（调试）',
      noContent: '暂无正文内容',
      noAttachments: '暂无附件',
      attStatus_pending: '待处理',
      attStatus_uploaded: '已上传',
      attStatus_upload_failed: '上传失败',
      attStatus_download_failed: '下载失败',
      createTask: '创建任务',
      editTask: '编辑任务',
      taskName: '任务名称',
      siteId: '站点标识',
      targetUrl: '列表页网址',
      pageUrlTemplate: '分页网址模板（含 {page}）',
      maxPages: '最大页数',
      extractionSchema: '列表提取规则（CSS Schema）',
      extractionSchemaHint:
        'baseSelector 为列表项选择器，fields 定义 title/url/date 等字段的提取方式',
      detailConfig: '详情页配置',
      detailConfigHint:
        'url_field 为详情链接字段名，content_selector 限定正文区域，attachment_extensions 为附件后缀',
      uploadToKb: '上传到知识库并解析',
      selectKb: '选择知识库',
      kbRequired: '请选择目标知识库',
      requiredFieldsMissing: '请填写任务名称、站点标识和列表页网址',
      invalidJson: 'JSON 格式无效',
      saveSuccess: '保存成功',
      saveFailed: '保存失败',
      lastRun: '上次运行',
      lastRunSummary: '运行结果',
      summaryText: '{{pages}} 页 / 发现 {{found}} 条 / 新增 {{added}} 条',
      noTasks: '暂无采集任务',
      trigger: '立即采集',
      triggerSuccess: '已触发采集，稍后刷新查看结果',
      triggerFailed: '触发失败',
      run_success: '成功',
      run_fail: '失败',
      run_running: '运行中',
      ...
      live: '实时',
      connecting: '连接中...',
      waitingForProgress: '等待进度数据...',
      pageOf: '第 {{current}} / {{total}} 页',
      pageUnknown: '第 {{current}} 页',
      newCount: '新增 {{count}}',
      scannedCount: '扫描 {{count}}',
      logTitle: '日志',
      noLogs: '暂无日志',
      finalSummary: '采集汇总',
      detect: {
        tab: '探测监控',
        title: '探测监控',
        subtitle: '实时探测站点新数据 · 自适应频率 · 发现新数据自动入队采集',
        statsTotal: '总站点',
        statsActive: '活跃',
        statsCold: '冷门',
        statsDue: '待探测',
        statsError: '错误',
        statsAutoDisabled: '自动禁用',
        statsManualDisabled: '手动禁用',
        statsNeverProbed: '未探测',
        statsAvgInterval: '平均间隔',
        install: '注册/更新探测器',
        installPrompt: '请输入用于采集入库的 KB ID',
        installSuccess: '探测器 meta-task 已注册',
        installFailed: '注册失败',
        site: '站点',
        category: '类型',
        status: '状态',
        ...
        statusManualDisabled: '手动禁用',
        statusNeverProbed: '未探测',
        missCount: '未命中',
        curInterval: '当前间隔',
        nextRunIn: '下次探测',
        lastCheck: '上次探测',
        ...
        reasonLocked: '被锁',
        reasonError: '出错',
        actionReset: '重置 backoff',
        actionTrigger: '立即探测',
        actionDisable: '禁用',
        actionEnable: '启用',
        resetSuccess: '已重置',
        triggerSuccess: '已标记立即探测',
        disableSuccess: '已禁用',
        enableSuccess: '已启用',
        opFailed: '操作失败',
        seconds: '秒',
