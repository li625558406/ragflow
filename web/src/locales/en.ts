...
This process aggregates variables from multiple branches into a single variable to achieve unified configuration for downstream nodes.`,
      ...
      bidSearch: 'Bid search',
      bidSearchDescription: 'Search Chinese procurement bid projects.',
      bidGetDetail: 'Bid get detail',
      bidGetDetailDescription: 'Get full detail of a bid project.',
      bidImportToKb: 'Bid import to KB',
      bidImportToKbDescription: 'Import bid project into knowledge base.',
      bidCheckImportStatus: 'Bid check import status',
      bidCheckImportStatusDescription:
      ...
      tenderSearchTitle: 'Bid Search',
      tenderSearchDescription:
        'Search nationwide bidding procurement information',
      tenderKeyword: 'Keyword',
      tenderKeywordPlaceholder: 'Enter keyword (at least 2 characters)...',
      tenderSearchMode: 'Search mode',
      tenderFuzzy: 'Fuzzy search',
      tenderPrecise: 'Precise search',
      tenderAnnouncementType: 'Announcement type',
      tenderAllTypes: 'All types',
      tenderBidAnnouncement: 'Bid announcement',
      tenderBidResult: 'Bid result',
      tenderPublishDate: 'Publish date',
      tenderSearching: 'Searching...',
      tenderSearchBtn: 'Search bids',
      tenderResults: 'results',
      tenderNoResults: 'No matching results',
      tenderNoResultsHint: 'Please adjust search criteria and try again',
      tenderBack: 'Back',
      tenderStaleCache: 'Cached data may be outdated, refresh recommended',
      tenderQueryFailed: 'Query failed',
      tenderLoadComplete: 'All results shown',
      tenderLoadingMore: 'Loading...',
      tenderLoaded: 'Loaded',
      tenderBudget: 'Budget:',
      tenderWinBid: 'Win bid:',
      tenderContractLabel: 'Contract:',
      tenderBidOpening: 'Bid opening:',
      tenderBidDeadline: 'Bid deadline:',
      tenderWinCandidate: 'Win candidates:',
      tenderAgency: 'Agency:',
      tenderBadgeBid: 'Bid',
      tenderBadgeWin: 'Win',
      tenderBadgeDefault: 'Bid',
      tenderTotal: 'Total',
      ...
      logTimeline: {
        ...
        bidSearch: 'Searching bid projects',
        bidGetDetail: 'Fetching bid details',
        bidImportToKb: 'Importing bid to KB',
        bidCheckImportStatus: 'Checking import status',
        bidLookupCode: 'Looking up codes',
...
[Insert text here]`,
    ...
    scheduledTasks: {
      ...
      targetUrlPlaceholder: 'Enter the target URL to crawl',
      accessToken: 'Access Token',
      accessTokenPlaceholder: 'Enter access token for authenticated crawling',
      llmModel: 'Image Analysis Model',
      llmModelPlaceholder: 'Select LLM model for image analysis',
      targetKb: 'Target Knowledge Base',
      targetKbPlaceholder: 'Select the knowledge base to store results',
      running: 'Running',
      success: 'Success',
      fail: 'Fail',
      noTasks: 'No scheduled tasks yet',
      createTaskHint:
        'Create a scheduled task to run Python scripts periodically',
      taskNameRequired: 'Task name is required',
      scriptPathRequired: 'Script path is required',
      crawlerState: 'Crawler State',
      crawlerStateSaveSuccess: 'Saved successfully',
      crawlerStateSaveFailed: 'Save failed',
      crawlerStateInvalidJson: 'Invalid JSON format',
      log: {
      ...
      taskType: 'Task Type',
      taskTypeScript: 'Generic Script',
      taskTypeWechatMp: 'WeChat Official Account',
      wechatMpAuth: 'WeChat Auth',
      wechatMpScanLogin: 'Scan QR to Login',
      wechatMpLoggedIn: 'Logged In',
      wechatMpLogout: 'Logout',
      wechatMpSearchPlaceholder: 'Search official accounts...',
      wechatMpSelectedAccounts: 'Selected Accounts',
      wechatMpGatherContent: 'Fetch article body content',
      wechatMpNoAccount: 'Please add an account first',
      wechatMpQrScanning: 'Scan QR code with WeChat',
      wechatMpAuthExpired: 'Login expired, please scan again',
      wechatMpFirstMaxPage: 'First-time full crawl max pages',
      wechatMpFirstMaxPageHint:
        'Number of pages for the first full crawl (1 page = 5 articles). Subsequent runs only fetch the latest 1 page.',
    },
    crawl4ai: {
      title: 'Smart Crawler',
      results: 'Results',
      ...
      statusRaw: 'Crawled',
      statusKbUploaded: 'In knowledge base',
      statusFailed: 'Failed',
      status_raw: 'Crawled',
      status_kb_uploaded: 'In knowledge base',
      ...
      fieldName: 'Field',
      fieldValue: 'Value',
      rawExtractedJson: 'Raw JSON (debug)',
      noContent: 'No content',
      noAttachments: 'No attachments',
      attStatus_pending: 'Pending',
      attStatus_uploaded: 'Uploaded',
      attStatus_upload_failed: 'Upload failed',
      attStatus_download_failed: 'Download failed',
      createTask: 'Create task',
      editTask: 'Edit task',
      taskName: 'Task name',
      siteId: 'Site ID',
      targetUrl: 'Listing page URL',
      pageUrlTemplate: 'Pagination URL template (with {page})',
      maxPages: 'Max pages',
      extractionSchema: 'Listing extraction schema (CSS)',
      extractionSchemaHint:
        'baseSelector matches each list item; fields define how to extract title/url/date etc.',
      detailConfig: 'Detail page config',
      detailConfigHint:
        'url_field is the detail link field; content_selector scopes the content region; attachment_extensions lists file suffixes',
      uploadToKb: 'Upload to knowledge base and parse',
      selectKb: 'Select knowledge base',
      kbRequired: 'Please select a target knowledge base',
      requiredFieldsMissing:
        'Task name, site ID and listing page URL are required',
      invalidJson: 'Invalid JSON format',
      saveSuccess: 'Saved successfully',
      saveFailed: 'Save failed',
      lastRun: 'Last run',
      lastRunSummary: 'Run summary',
      summaryText: '{{pages}} pages / {{found}} found / {{added}} new',
      noTasks: 'No crawler tasks yet',
      trigger: 'Run now',
      triggerSuccess: 'Crawl triggered, refresh later to see results',
