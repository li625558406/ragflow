...
export const SVGIconMap = {
  ...
  [Operator.ConstructionImportToKb]: 'bid-import-to-kb',
  [Operator.ConstructionCheckImportStatus]: 'bid-check-status',
  [Operator.ContractImportToKb]: 'bid-import-to-kb',
  [Operator.ContractCheckImportStatus]: 'bid-check-status',
  [Operator.EnterpriseImportToKb]: 'bid-import-to-kb',
  [Operator.EnterpriseCheckImportStatus]: 'bid-check-status',
