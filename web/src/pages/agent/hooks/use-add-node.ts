...
import {
  ...
  initialBidConstructionSearchValues,
  initialBidEnterpriseProfileValues,
  initialBidGetDetailValues,
  initialBidGetSourceValues,
  initialBidImportToKbValues,
  initialBidIndustryTagValues,
  initialBidLookupCodeValues,
  initialBidRewriteQueryValues,
  initialBidSearchAIValues,
  initialBidSearchContractValues,
  initialBidSearchValues,
  initialBingValues,
  initialCategorizeValues,
  initialCodeValues,
  initialConstructionCheckImportStatusValues,
  initialConstructionImportToKbValues,
  initialContractCheckImportStatusValues,
  initialContractImportToKbValues,
  ...
  initialDuckValues,
  initialEmailValues,
  initialEnterpriseCheckImportStatusValues,
  initialEnterpriseImportToKbValues,
  initialExeSqlValues,
...
export const useInitializeOperatorParams = () => {
  ...
  const initialFormValuesMap = useMemo(() => {
    return {
      ...
      [Operator.FanOut]: initialFanOutValues,
      ...
      [Operator.TemplateFill]: initialTemplateFillValues,
      [Operator.FileReview]: initialFileReviewValues,
      ...
      [Operator.ConstructionImportToKb]: initialConstructionImportToKbValues,
      [Operator.ConstructionCheckImportStatus]:
        initialConstructionCheckImportStatusValues,
      [Operator.ContractImportToKb]: initialContractImportToKbValues,
      [Operator.ContractCheckImportStatus]:
        initialContractCheckImportStatusValues,
      [Operator.EnterpriseImportToKb]: initialEnterpriseImportToKbValues,
      [Operator.EnterpriseCheckImportStatus]:
        initialEnterpriseCheckImportStatusValues,
      [Operator.BidLookupCode]: initialBidLookupCodeValues,
      [Operator.BidGetSource]: initialBidGetSourceValues,
      [Operator.BidSearchAI]: initialBidSearchAIValues,
      [Operator.BidSearchContract]: initialBidSearchContractValues,
      [Operator.BidRewriteQuery]: initialBidRewriteQueryValues,
