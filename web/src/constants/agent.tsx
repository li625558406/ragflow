...
export enum Operator {
  ...
  BidSearch = 'BidSearch',
  BidGetDetail = 'BidGetDetail',
  BidImportToKb = 'BidImportToKb',
  BidCheckImportStatus = 'BidCheckImportStatus',
  ConstructionImportToKb = 'ConstructionImportToKb',
  ConstructionCheckImportStatus = 'ConstructionCheckImportStatus',
  ContractImportToKb = 'ContractImportToKb',
  ContractCheckImportStatus = 'ContractCheckImportStatus',
  EnterpriseImportToKb = 'EnterpriseImportToKb',
  EnterpriseCheckImportStatus = 'EnterpriseCheckImportStatus',
  BidLookupCode = 'BidLookupCode',
  BidGetSource = 'BidGetSource',
  BidSearchAI = 'BidSearchAI',
  BidSearchContract = 'BidSearchContract',
  BidRewriteQuery = 'BidRewriteQuery',
  BidIndustryTag = 'BidIndustryTag',
  BidEnterpriseProfile = 'BidEnterpriseProfile',
  BidConstructionSearch = 'BidConstructionSearch',
